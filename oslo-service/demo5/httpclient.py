...
if __name__ == '__main__':
    ...
    # #--------------------------
    # resp = httpclient.request("http://localhost:9001/test", "POST", "{'a':'b'}")
    # print(resp.text)
    # #--------------------------
    # resp_post = httpclient.post("http://localhost:9001/test", json={'a': 'b'})
    # print(resp_post.text)
    # #--------------------------
    resp_get = httpclient.get("http://localhost:9001/test")
    print(resp_get.text)
